...
from MPO500.mpo500_utils import MPO500

''' Create Custom Enviroment based on GYM Enviroment Class'''


class MPO500_Env(gym.Env):
    ...
    Attributes:
        ...
        mpo500 (:obj:): Robot utilities object.
    ...
    def __init__(self):
        ...
        ''' Initialization of the Action that we can take, the Space (robot model...), the Observation Space, the Lenght... '''
        ...
        # Maximum linear (m/s) and angular velocities (rad/s) of MPO500
        self.max_vel = np.array([self.robot.get_max_lin_vel, self.robot.get_max_ang_vel])
    ...
    def reset(self, start_pose = None, target_pose = None):
        ...
        ''' Reset the Enviroment after each Training Run / Episode '''
        ...
        '''STATE:
            ...
            target = [0.0] * 3              # Create a vector of 3 elements 0.0
            mir_pose = [0.0] * 3
            mir_twist = [0.0] * 2
            f_scan = [0.0] * 501
            b_scan = [0.0] * 511
        ...
        robot_pose = utils.array_initialization
...
#         ''' Define what we do whenever we Take a Step, how we Treat Actions '''
        
#         # Apply the Desired Action
#         self.state += action - 1
        
#         # Reduce Lenght (0.5 m/s -> compute speed ...)
...
#         ''' Visualizations for the Enviroment '''
...
if __name__ == '__main__':
    ...
    test = MPO500_Env()
    test.reset(start_pose = [0.0,1.0,2.0], target_pose = [3.0,4.0,5.0])
